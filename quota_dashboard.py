...
The quota list (44 order numbers) is baked in below. For each order number it
pulls the live remaining balance from the HMRC trade-tariff API and writes
public/index.html, movers.html, trends.html plus a daily snapshot log.
